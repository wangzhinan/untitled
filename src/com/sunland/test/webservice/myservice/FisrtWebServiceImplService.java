 ...
 * 
 */
@WebServiceClient(name = "FisrtWebServiceImplService", targetNamespace = "http://server.webservice.test.sunland.com/", wsdlLocation = "http://localhost:9999/getAddress?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FISRTWEBSERVICEIMPLSERVICE_QNAME = new QName("http://server.webservice.test.sunland.com/", "FisrtWebServiceImplService");
    ...
    public FisrtWebServiceImpl getFisrtWebServiceImplPort() {
        return super.getPort(new QName("http://server.webservice.test.sunland.com/", "FisrtWebServiceImplPort"), FisrtWebServiceImpl.class);
    }
    ...
    public FisrtWebServiceImpl getFisrtWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.test.sunland.com/", "FisrtWebServiceImplPort"), FisrtWebServiceImpl.class, features);
    }
